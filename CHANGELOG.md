...
### [3.4.29](https://sdk.apptimize.com/ios/3.4.29) - 27 July 2021
...
### [3.4.25](https://sdk.apptimize.com/ios/3.4.25) - 10 May 2021
...
### [3.4.21](https://sdk.apptimize.com/ios/3.4.21) - 17 March 2021
   * Updated ApptimizeInitialized notification logic
   * Added Catalyst applications support
   * Internal improvements

### [3.4.20](https://sdk.apptimize.com/ios/3.4.20) - 23 February 2021
...
### [3.4.18](https://sdk.apptimize.com/ios/3.4.18) - 21 January 2021
   * Updated API documentation and Feature Variables support

### [3.4.17](https://sdk.apptimize.com/ios/3.4.17) - 18 January 2021
   * Improved logging for resources failing to load

### [3.4.16](https://sdk.apptimize.com/ios/3.4.16) - 15 January 2021
   * Build has been retracted

### [3.4.15](https://sdk.apptimize.com/ios/3.4.15) - 18 December 2020
   * Fix pairing handshake bug on production apps

### [3.4.14](https://sdk.apptimize.com/ios/3.4.14) - 17 December 2020
   * Changed misleading parameter type in waitForTestsToBecomeAvailable from NSTimeInterval to double

### [3.4.13](https://sdk.apptimize.com/ios/3.4.13) - 14 December 2020
...
### [3.4.12](https://sdk.apptimize.com/ios/3.4.12) - 10 December 2020
   * Build has been retracted
### [3.4.11](https://sdk.apptimize.com/ios/3.4.11) - 08 December 2020
   * Build has been retracted.

### [3.4.10](https://sdk.apptimize.com/ios/3.4.10) - 10 November 2020
...
### [3.4.9](https://sdk.apptimize.com/ios/3.4.9) - 26 October 2020
...
### [3.4.8](https://sdk.apptimize.com/ios/3.4.8) - 20 October 2020
   * Migrate to using XCFrameworks
     * Support ARM based simulators in XCode 12
     * Future platform support

### [3.4.7](https://sdk.apptimize.com/ios/3.4.7) - 07 October 2020
...
### [3.4.6](https://sdk.apptimize.com/ios/3.4.6) - 01 September 2020
   * Fix a crash when MainThreadChecker is enabled.
   * Remove unused library dependencies.

### [3.4.5](https://sdk.apptimize.com/ios/3.4.5) - 31 August 2020
   * Add support for EU region customers

### [3.4.4](https://sdk.apptimize.com/ios/3.4.4) - 10 August 2020
   * Fix a crash on iOS 14.0 (rarely on other iOS versions)

### [3.4.3](https://sdk.apptimize.com/ios/3.4.3) - 06 August 2020
   * Update podspec to include the swift version number.

### [3.4.2](https://sdk.apptimize.com/ios/3.4.2) - 04 August 2020
...
### [3.4.1](https://sdk.apptimize.com/ios/3.4.1) - 23 July 2020
   * Disable clipboard check on iOS14+.

### [3.4.0](https://sdk.apptimize.com/ios/3.4.0) - 16 July 2020
...
### [3.3.7](https://sdk.apptimize.com/ios/3.3.7) - 13 July 2020
   * Internal changes to prepare for future iOS SDK releases.

### [3.3.6](https://sdk.apptimize.com/ios/3.3.6) - 27 May 2020

### [3.3.5](https://sdk.apptimize.com/ios/3.3.5) - 19 May 2020
   * Enable developer mode websocket pairing from watchOS

### [3.3.4](https://sdk.apptimize.com/ios/3.3.4) - 23 March 2020
...
### [3.3.3](https://sdk.apptimize.com/ios/3.3.3) - 20 March 2020
...
### [3.3.2](https://sdk.apptimize.com/ios/3.3.2) - 20 February 2020
   * Add option to allow forced refresh of metadata at startup.

### [3.3.1](https://sdk.apptimize.com/ios/3.3.1) - 10 February 2020
...
### [3.3.0](https://sdk.apptimize.com/ios/3.3.0) - 28 January 2020
   * Support metadata-driven opt-in mechanism for integration with other analytics frameworks

### [3.2.6](https://sdk.apptimize.com/ios/3.2.6) - 27 January 2020
   * Fixed a rare crash in Google Analytics integration

### [3.2.5](https://sdk.apptimize.com/ios/3.2.5) - 18 December 2019
...
### [3.2.4](https://sdk.apptimize.com/ios/3.2.4) - 12 December 2019
   * Fixed a different memory leak introduced in 3.2.3.

### [3.2.3](https://sdk.apptimize.com/ios/3.2.3) - 14 November 2019
...
### [3.2.2](https://sdk.apptimize.com/ios/3.2.2) - 07 November 2019
   * Revert memory leak fix to address unexpected crash

### [3.2.1](https://sdk.apptimize.com/ios/3.2.1) - 30 October 2019
   * Fixed a memory leak when using UITableView and UICollectionView

### [3.2.0](https://sdk.apptimize.com/ios/3.2.0) - 29 October 2019
...
### [3.1.18](https://sdk.apptimize.com/ios/3.1.18) - 11 October 2019
   * Fix for dynamic variables of different types with same name

### [3.1.17](https://sdk.apptimize.com/ios/3.1.17) - 20 September 2019
   * Add ApptimizeInitializedNotification - called after setup is complete and tests are ready to be run

### [3.1.16](https://sdk.apptimize.com/ios/3.1.16) - 17 September 2019
   * Allow Apptimize.forceVariant to optionally show winners and hotfixes

### [3.1.15](https://sdk.apptimize.com/ios/3.1.15) - 31 July 2019
   * Updates to API documentation

### [3.1.14](https://sdk.apptimize.com/ios/3.1.14) - 23 July 2019
   * Fix a memory leak that may occur under specific circumstances

### [3.1.13](https://sdk.apptimize.com/ios/3.1.13) - 03 July 2019
...
### [3.1.12](https://sdk.apptimize.com/ios/3.1.12) - 13 May 2019
   * Add missing nullability tag
     - Fixes a warning when including the Apptimize header file.

### [3.1.11](https://sdk.apptimize.com/ios/3.1.11) - 03 April 2019
   * Fix ApptimizeDelayUntilTestsAreAvailable value being ignored

### [3.1.10](https://sdk.apptimize.com/ios/3.1.10) - 19 February 2019
...
### [3.1.9](https://sdk.apptimize.com/ios/3.1.9) - 01 February 2019
   * Enhanced internal performance metrics

### [3.1.8](https://sdk.apptimize.com/ios/3.1.8) - 10 December 2018
   * Support visual editing when used alongside RxCocoa/RxSwift.

### [3.1.7](https://sdk.apptimize.com/ios/3.1.7) - 16 November 2018
   * Ensure userHasParticipated in ApptimizeTestInfo is accurate for the duration of an experiment

### [3.1.6](https://sdk.apptimize.com/ios/3.1.6) - 05 October 2018
   * Address potential conflict between setPilotTargetingId and setCustomerUserId

### [3.1.5](https://sdk.apptimize.com/ios/3.1.5) - 28 August 2018
   * Fix rare deadlock when using setCustomerUserId at the same time as results are being generated

### [3.1.4](https://sdk.apptimize.com/ios/3.1.4) - 20 August 2018
   * Add support for importing Firebase events and attributes

### [3.1.3](https://sdk.apptimize.com/ios/3.1.3) - 17 August 2018
   * Further stability improvements surrounding threading.

### [3.1.2](https://sdk.apptimize.com/ios/3.1.2) - 16 August 2018
   * Stability improvements.

### [3.1.1](https://sdk.apptimize.com/ios/3.1.1) - 20 July 2018
   * Support proxies for pairing

### [3.1.0](https://sdk.apptimize.com/ios/3.1.0) - 24 May 2018
...
### [3.0.1](https://sdk.apptimize.com/ios/3.0.1) - 09 February 2018
   * Fix to ensure pasteboard isn't accessed when pairing is disabled

### [3.0.0](https://sdk.apptimize.com/ios/3.0.0) - 01 February 2018
...
### [2.20.24](https://sdk.apptimize.com/ios/2.20.24) - 07 December 2017
   * Pasteboard stability improvements.

### [2.20.23](https://sdk.apptimize.com/ios/2.20.23) - 01 December 2017
   * Optimize network traffic.

### [2.20.22](https://sdk.apptimize.com/ios/2.20.22) - 27 November 2017
   * Add support for Swift apps when using the tvOS SDK.

### [2.20.21](https://sdk.apptimize.com/ios/2.20.21) - 26 October 2017
   * Fix error in first run attribute for variant enrollment.

### [2.20.20](https://sdk.apptimize.com/ios/2.20.20) - 12 October 2017
   * Add annotations to the API to improve API usage from Swift apps

### [2.20.19](https://sdk.apptimize.com/ios/2.20.19) - 04 October 2017
   * Add additional logging to indicate whether this is a developer build or not.

### [2.20.18](https://sdk.apptimize.com/ios/2.20.18) - 14 September 2017
   * Fix an issue when importing Localytics standard events with nil parameters

### [2.20.17](https://sdk.apptimize.com/ios/2.20.17) - 07 September 2017
   * Add support for importing Localytics standard events

### [2.20.16](https://sdk.apptimize.com/ios/2.20.16) - 16 August 2017
   * Fix image caching issue forcing experiment data to redownload

### [2.20.15](https://sdk.apptimize.com/ios/2.20.15) - 09 August 2017
   * Fix an issue where screenshots weren't being updated when the visual editor is disabled.

### [2.20.14](https://sdk.apptimize.com/ios/2.20.14) - 03 August 2017
   * Stability improvements.

### [2.20.13](https://sdk.apptimize.com/ios/2.20.13) - 02 August 2017
   * Stop posting notifications for all variants set to "Show to all users"

### [2.20.12](https://sdk.apptimize.com/ios/2.20.12) - 28 July 2017
   * SDK versioning cleanup

### [2.20.11](https://sdk.apptimize.com/ios/2.20.11) - 27 July 2017
   * Add support for FBAudienceNetwork

### [2.20.10](https://sdk.apptimize.com/ios/2.20.10) - 24 July 2017
   * Minor internal technical improvements regarding memory management.

### [2.20.9](https://sdk.apptimize.com/ios/2.20.9) - 21 July 2017
   * Fix an issue where querying an undefined feature flag can result in a dynamic variable being created unintentionally

### [2.20.8](https://sdk.apptimize.com/ios/2.20.8) - 19 July 2017
   * SDK setup and load time optimizations

### [2.20.7](https://sdk.apptimize.com/ios/2.20.7) - 12 July 2017
   * Export Amplitude custom attributes for targeting and filtering.

### [2.20.6](https://sdk.apptimize.com/ios/2.20.6) - 06 July 2017
   * Fix an issue where results fail to post if a custom attribute of an unsupported type is set by the Segment integration.

### [2.20.5](https://sdk.apptimize.com/ios/2.20.5) - 05 July 2017
   * Add front page summary text to the API documentation.

### [2.20.4](https://sdk.apptimize.com/ios/2.20.4) - 29 June 2017
   * Add Visual Support for Cedar testing framework.  Resolve conflicts with spying on visual elements.

### [2.20.3](https://sdk.apptimize.com/ios/2.20.3) - 23 June 2017
   * Add additional logging output for experiment data

### [2.20.2](https://sdk.apptimize.com/ios/2.20.2) - 09 June 2017
   * Major API documentation overhaul. Added Swift method names and updated all API descriptions.

### [2.20.1](https://sdk.apptimize.com/ios/2.20.1) - 08 June 2017
...
### [2.20.0](https://sdk.apptimize.com/ios/2.20.0) - 25 May 2017
   * Add new object-oriented API, ApptimizeVariable, for dynamic variables.

### [2.19.2](https://sdk.apptimize.com/ios/2.19.2) - 23 May 2017
   * Migrate documentation from CocoaDocs

### [2.19.1](https://sdk.apptimize.com/ios/2.19.1) - 11 May 2017
   * Export Localytics custom dimensions for targeting and filtering.

### [2.19.0](https://sdk.apptimize.com/ios/2.19.0) - 18 April 2017
   * Apptimize Apple TV Support Added

### [2.18.3](https://sdk.apptimize.com/ios/2.18.3) - 07 April 2017
   * Fix for advance verify

### [2.18.2](https://sdk.apptimize.com/ios/2.18.2) - 29 March 2017
...
### [2.18.1](https://sdk.apptimize.com/ios/2.18.1) - 20 March 2017
   * Stability fix for the WYSIWYG Editor

### [2.18.0](https://sdk.apptimize.com/ios/2.18.0) - 17 February 2017
   * Convert Apptimize.Framework from static to dynamic framework
   * Stability fix for the WYSIWYG Editor

### [2.17.1](https://sdk.apptimize.com/ios/2.17.1) - 24 January 2017
   * Fix testInfo retention on experiment changes

### [2.17.0](https://sdk.apptimize.com/ios/2.17.0) - 09 December 2016
...
### [2.16.18](https://sdk.apptimize.com/ios/2.16.18) - 29 November 2016
   * Method for Appboy integration

### [2.16.17](https://sdk.apptimize.com/ios/2.16.17) - 21 November 2016
...
### [2.16.16](https://sdk.apptimize.com/ios/2.16.16) - 20 October 2016
   * Fix rare resetting of a user's GUID
   * Fix possible delay at startup with a paired clipboard between iOS 10 and Sierra

### [2.16.15](https://sdk.apptimize.com/ios/2.16.15) - 14 October 2016
...
### [2.16.14](https://sdk.apptimize.com/ios/2.16.14) - 20 September 2016
   * Address WYSIWYG programmatic startup bug

### [2.16.13](https://sdk.apptimize.com/ios/2.16.13) - 31 August 2016
   * iOS 10 support: Fix UILabel initially black background. Fix screenshot alpha blending.

### [2.16.12](https://sdk.apptimize.com/ios/2.16.12) - 10 August 2016
   * Add support for Amplitude 3.7+

### [2.16.11](https://sdk.apptimize.com/ios/2.16.11) - 05 August 2016
   * Fix cleanup bug in migration code that crashed Realms et. al. on simulator

### [2.16.10](https://sdk.apptimize.com/ios/2.16.10) - 27 July 2016
   * Work around iOS UIImage threading bugs on ios 8 and 9

### [2.16.9](https://sdk.apptimize.com/ios/2.16.9) - 22 July 2016
   * Stability improvements around local file storage, including migration

### [2.16.8](https://sdk.apptimize.com/ios/2.16.8) - 15 June 2016
   * Stability improvements

### [2.16.7](https://sdk.apptimize.com/ios/2.16.7) - 10 June 2016
   * Stability improvements

### [2.16.6](https://sdk.apptimize.com/ios/2.16.6) - 02 June 2016
   * Stability improvements

### [2.16.5](https://sdk.apptimize.com/ios/2.16.5) - 06 May 2016
   * Stability improvements
   * Visual changes to labels with nil text

### [2.16.4](https://sdk.apptimize.com/ios/2.16.4) - 18 April 2016
   * Support for FBAudienceNetwork

### [2.16.3](https://sdk.apptimize.com/ios/2.16.3) - 08 April 2016
   * Amplitude auto import of events
   * Visual experiment improvements
   * Targeting bug fix

### [2.16.2](https://sdk.apptimize.com/ios/2.16.2) - 26 February 2016
   * Improve localytics integration
   * Stability improvements

### [2.16.1](https://sdk.apptimize.com/ios/2.16.1) - 16 February 2016
   * Improve handling of layout in visual editor

### [2.16.0](https://sdk.apptimize.com/ios/2.16.0) - 29 January 2016
...
### [2.15.6](https://sdk.apptimize.com/ios/2.15.6) - 27 January 2016

   * Improve SDK stability

### [2.15.5](https://sdk.apptimize.com/ios/2.15.5) - 18 January 2016

   * Performance improvements

### [2.15.4](https://sdk.apptimize.com/ios/2.15.4) - 28 December 2015

   * Improve SDK stability

### [2.15.3](https://sdk.apptimize.com/ios/2.15.3) - 10 December 2015

   * Fix crash generating snapshots of views with frames set to CGRectNull

### [2.15.2](https://sdk.apptimize.com/ios/2.15.2) - 9 December 2015

   * Export experiment participation to Localytics
   * Fix intermittent issue saving events to disk

### [2.15.1](https://sdk.apptimize.com/ios/2.15.1) - 19 November 2015

   * Fix rare intermittent crash in result logging

### [2.15.0](https://sdk.apptimize.com/ios/2.15.0) - 23 October 2015

   * Autoimport Localytics events

### [2.14.2](https://sdk.apptimize.com/ios/2.14.2) - 13 October 2015
...
### [2.14.1](https://sdk.apptimize.com/ios/2.14.1) - 7 October 2015

   * wysiwyg performance improvements for advanced verify

### [2.14.0](https://sdk.apptimize.com/ios/2.14.0) - 22 September 2015

   * iOS9 support for bitcode & ATS (https)

### [2.13.1](https://sdk.apptimize.com/ios/2.13.1) - 10 September 2015

   * Fix rare crash while background the app

### [2.13.0](https://sdk.apptimize.com/ios/2.13.0) - 3 September 2015

   * Swift support for code blocks

### [2.12.2](https://sdk.apptimize.com/ios/2.12.2) - 25 August 2015


### [2.12.1](https://sdk.apptimize.com/ios/2.12.1) - 6 August 2015

   * Bug fixes for two cases where nil external data would crash the app

### [2.12.0](https://sdk.apptimize.com/ios/2.12.0) - 24 July 2015

   * Added [Apptimize setOffline:flag] and [Apptimize isOffline]
   * Improved event logging performance

### [2.11.1](https://sdk.apptimize.com/ios/2.11.1) - 13 July 2015
...
### [2.11.0](https://sdk.apptimize.com/ios/2.11.0) - 22 May 2015
...
### [2.10.0.1](https://sdk.apptimize.com/ios/2.10.0.1) - 3 May 2015
...
### [2.10.0](https://sdk.apptimize.com/ios/2.10.0) - 27 April 2015
...
### [2.9.5](https://sdk.apptimize.com/ios/2.9.5) - 23 April 2015

   * Bug fixes

### [2.9.4](https://sdk.apptimize.com/ios/2.9.4) - 17 March 2015
...
### [2.9.3](https://sdk.apptimize.com/ios/2.9.3) - 26 February 2015
...
### [2.9.2](https://sdk.apptimize.com/ios/2.9.2) - 05 February 2015
